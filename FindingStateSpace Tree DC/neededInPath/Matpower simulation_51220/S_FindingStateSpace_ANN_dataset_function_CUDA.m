function [States] = S_FindingStateSpace_ANN_dataset_function_CUDA(CaseName, Iterations, InitialFailures, LoadGenerationRatio, LoadShedConstant, EstimationError)
%clc;
%clear all;
%close all;
define_constants;
